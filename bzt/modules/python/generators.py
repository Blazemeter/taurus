...
from bzt.utils import PythonGenerator, dehumanize_time, ensure_is_dict, LoggedObj
...
class JMeterExprCompiler(LoggedObj):
    def __init__(self, parent_log=None):     # support deprecated logging interface
        super(JMeterExprCompiler, self).__init__()
...
from bzt.resources import selenium_taurus_extras
    ...
    def __init__(self, scenario, parent_logger=None, wdlog="", ignore_unknown_actions=False):
        super(SeleniumScriptBuilder, self).__init__(scenario)
...
class ApiritifScriptGenerator(PythonGenerator):
    ...
    def __init__(self, scenario, label, parent_log=None):   # support deprecated logging interface
        super(ApiritifScriptGenerator, self).__init__(scenario)
        self.scenario = scenario
        self.label = label
        self.tree = None
        self.verbose = False
        self.expr_compiler = JMeterExprCompiler()
