...
class ApiritifNoseExecutor(SubprocessedExecutor):
    ...
    def __tests_from_requests(self):
        ...
        if test_mode == "apiritif":
            ...
            builder = ApiritifScriptGenerator(scenario, self.label, self.engine.find_file, self.log)
            ...
            builder = SeleniumScriptBuilder(self.get_scenario(), self.log, wdlog, self.engine, ignore_unknown_actions)
