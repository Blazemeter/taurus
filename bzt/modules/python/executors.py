...
class ApiritifNoseExecutor(SubprocessedExecutor):
    ...
    def __tests_from_requests(self):
        ...
        if test_mode == "apiritif":
            ...
            builder.webdriver_address = self.settings.get("webdriver-address", builder.webdriver_address)
            builder.webdriver_address = self.execution.get("webdriver-address", builder.webdriver_address)
