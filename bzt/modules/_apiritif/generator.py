...
"""
    ...
    def _gen_action(self, action_config, parent_request=None):
    ...
    def _gen_loop_mngr(self, action_config, parent_request=None):
        ...
        if parent_request and parent_request.config.get('spar2539', False) is True:
    ...
    def _gen_http_request(self, req):
        ...
        if self.test_mode == "selenium":
            ...
            for action in actions:
                action_lines = self._gen_action(action, req)
                if self.generate_external_handler:
    ...
    def _create_action_label(self, prefix, action):
        keep_special = "._-:()?/="
        replace_special = " $"
