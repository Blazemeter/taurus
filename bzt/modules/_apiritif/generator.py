            ...
            body=[
                ast.Expr(
                    value=ast.Call(
                        ...
                        args=[ast.Constant(value='before for, params: ', kind=""), ast.Name(id='params', ctx=ast.Load())],
                        keywords=[]
                    )
                ),
                ast.Expr(
                    value=ast.Call(
                        func=ast.Name(id='print', ctx=ast.Load()),
                        args=[ast.Constant(value='before for, command: ', kind=""), ast.Name(id='command', ctx=ast.Load())],
                        keywords=[]
                    )
                ),
                ast.Assign(
                ...
                ast.For(
                    ...
                    body=[
                        ast.Expr(
                            value=ast.Call(
                                func=ast.Name(id='print', ctx=ast.Load()),
                                args=[ast.Constant(value='inside for, params: ', kind=""), ast.Name(id='params', ctx=ast.Load())],
                                keywords=[]
                            )
                        ),
                        ast.Expr(
                            value=ast.Call(
                                func=ast.Name(id='print', ctx=ast.Load()),
                                args=[ast.Constant(value='inside for, params_copy: ', kind=""), ast.Name(id='params_copy', ctx=ast.Load())],
                                keywords=[]
                            )
                        ),
                        ast.Expr(
                            value=ast.Call(
                                func=ast.Name(id='print', ctx=ast.Load()),
                                args=[ast.Constant(value='inside for, command: ', kind=""), ast.Name(id='command', ctx=ast.Load())],
                                keywords=[]
                            )
                        ),
                        ast.Try(
                                ...
                                ast.If(
                                    ...
                                    body=[
                                        ast.Expr(
                                            value=ast.Call(
                                                func=ast.Name(id='print', ctx=ast.Load()),
                                                args=[ast.Constant(value='params != params_copy, using params_copy')],
                                                keywords=[]
                                            )
                                        ),
                                        ast.Return(
