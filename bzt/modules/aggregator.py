...
class ResultsReader(ResultsProvider):
    ...
    def get_mixed_label(label, kpis=None, f_type=None, msg=None):
        def not_embedded_error():
            return not(msg and msg.startswith("Embedded resource download error"))
        ...
        if f_type is not None:  # type of error from errors.jtl
            if (f_type == 1 or f_type == 2) and not_embedded_error():  # if it's assertion or subsample error...
            ...
            if msg is None:
                ...
                if rc < 300 and not_embedded_error():
