...
class TestConfigOverrider(BZTestCase):
    ...
    def test_override_multiple(self):
        self.config["items"] = [1, 2, 3]
        self.config["dict"] = {"listObj":[{"k1":"v1"}, {"k2":"v2"}, {"k3":"v3"}],"lislis":[1,2,3,4],"k1":"v3","k4=v4"}
        ...
        self.assertEqual(self.config.get("dict"), {'listObj': [{'k1': 'v2'}, {'k2': 'v2'}, {'k3': 'v3'}], 'lislis': [1, 2, 3, 4], 'k1': 'v2', 'k4': 'v4'})
