...
class TestRequests(unittest.TestCase):
    def setUp(self):
        self.driver = webdriver.Remote(command_executor='http://user:key@remote_web_driver_host:port/wd/hub' , desired_capabilities={'deviceName': '', 'javascriptEnabled': 'True', 'app': '', 'browserName': 'firefox', 'version': '54.0', 'platformVersion': '', 'platformName': 'linux', 'seleniumVersion': ''})
