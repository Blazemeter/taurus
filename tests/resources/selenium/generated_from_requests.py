...
from bzt.resources.selenium_extras import get_locator, replace_dialogs, FrameManager, answer_on_next_prompt, \
    WindowManager, get_next_prompt, get_next_confirm, answer_on_next_confirm, get_next_alert, wait_for
...
class TestLocSc(unittest.TestCase):
    ...
    def setUp(self):
        ...
        apiritif.put_into_thread_store(data_sources=True, timeout=timeout, func_mode=True, driver=self.driver,
