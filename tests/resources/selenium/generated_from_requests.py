...
class TestRequests(unittest.TestCase):
    ...
    def test_requests(self):
        ...
        with apiritif.transaction('/'):
            ...
            current_window = self.driver.current_window_handle; self.driver.switch_to_window(self.driver.window_handles[1]); self.driver.close(); self.driver.switch_to_window(current_window)
            self.driver.find_element(By.NAME, 'toPort').submit()
            self.driver.execute_script("alert('This is Sparta');")
            self.driver.switch_to_frame(self.driver.find_element(By.NAME, 'my_frame'))
