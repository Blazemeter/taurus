...
from bzt.resources.selenium_extras import wait_for, FrameManager, replace_dialogs, answer_on_next_prompt, WindowManager, \
    get_locator, get_next_alert, get_next_confirm, get_next_prompt, answer_on_next_confirm
...
class TestLocSc(unittest.TestCase):
    ...
    def setUp(self):
        ...
        apiritif.put_into_thread_store(func_mode=False, timeout=timeout, driver=self.driver, scenario_name='loc_sc')
    ...
    def _1_Test_V2(self):
        with apiritif.smart_transaction('Test V2'):
            ...
            self.wnd_mng.close()
            answer_on_next_prompt('my input')
            answer_on_next_confirm('#Ok')

            dialog = get_next_alert()
