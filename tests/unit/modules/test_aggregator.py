...
class TestResultsReader(BZTestCase):
    ...
    def test_1(self):
        ...
        for point in mock.datapoints():
            self.assertNotEquals(0, point[DataPoint.CUMULATIVE][''].concurrency.get())
    ...
    def test_max_concurrency(self):
        ...
        self.assertEqual(3, data_point[DataPoint.CURRENT][''].concurrency.get())
        self.assertEqual(3, data_point[DataPoint.CUMULATIVE][''].concurrency.get())
