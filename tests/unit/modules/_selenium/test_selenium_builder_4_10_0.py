...
from tests.unit.modules._selenium import SeleniumTestCase, MockPythonTool410
...
class TestSeleniumScriptGeneration(ExecutorTestCase):
    ...
    def setUp(self):
        ...
        bzt.modules._selenium.Selenium = MockPythonTool410
        bzt.modules._apiritif.executor.Apiritif = MockPythonTool410
        bzt.modules._apiritif.executor.Selenium = MockPythonTool410
    ...
    def test_nfc(self):
        ...
        self.obj.prepare()
        exp_file = RESOURCES_DIR + "selenium/test_nfc_4_10.py"
    ...
    def test_options_generator_firefox(self):
        self.configure({
            ...
            "scenarios": {
                "loc_sc": {
                    "capabilities": {
                        "browserName": "firefox",
                        "blazemeter.locationId": "harbor",
                        "blazemeter.parentSessionId": "r-v4",
                        "blazemeter.reportId": 111,
                        "blazemeter.testId": 222,
                    },
                    "browser": "Firefox",
                    "requests": [{
                        "url": "bla.com"}]}}, })
        ...
        self.assertIn("options.set_capability('bzm:options', bzm_options)", content)
        self.assertIn("bzm_options = {'blazemeter.locationId': 'harbor', 'blazemeter.parentSessionId': 'r-v4', "
                      "'blazemeter.reportId': 111, 'blazemeter.testId': 222}", content)
    ...
    def test_build_script(self):
        ...
        self.obj.prepare()
        exp_file = RESOURCES_DIR + "selenium/generated_from_requests_4_10.py"
        str_to_replace = (self.obj.engine.artifacts_dir + os.path.sep).replace('\\', '\\\\')
        self.assertFilesEqual(exp_file, self.obj.script, str_to_replace, "/somewhere/", python_files=True)
    ...
    def test_build_script_remote(self):
        ...
        self.obj.prepare()
        exp_file = RESOURCES_DIR + "selenium/generated_from_requests_remote_4_10.py"
    ...
    def test_build_script_appium_browser(self):
        ...
        self.obj.prepare()
        exp_file = RESOURCES_DIR + "selenium/generated_from_requests_appium_browser_4_10.py"
        self.assertFilesEqual(exp_file, self.obj.script, python_files=True)
            ...
            "scenarios": {
                "remote_sc": {
                    "capabilities": {
                        ...
                        "blazemeter.reportId": 111,
                        "blazemeter.testId": 222,
                    },  # must be set among other capabilities
                    "timeout": "3.5s",
                    "requests": [{
    ...
    def test_build_script_flow_markers(self):
        ...
        self.obj.prepare()
        exp_file = RESOURCES_DIR + "selenium/generated_from_requests_flow_markers_4_10.py"
        str_to_replace = (self.obj.engine.artifacts_dir + os.path.sep).replace('\\', '\\\\')
        self.assertFilesEqual(exp_file, self.obj.script, str_to_replace, "/somewhere/", python_files=True)
    ...
    def test_add_external_logging(self):
        ...
        self.obj.prepare()
        exp_file = RESOURCES_DIR + "selenium/external_logging_4_10.py"
        str_to_replace = (self.obj.engine.artifacts_dir + os.path.sep).replace('\\', '\\\\')
        self.assertFilesEqual(exp_file, self.obj.script, str_to_replace, "/somewhere/", python_files=True)
    ...
    def test_syntax2_build_script(self):
        ...
        self.obj.prepare()
        exp_file = RESOURCES_DIR + "selenium/generated_from_requests_v2_4_10.py"
        str_to_replace = (self.obj.engine.artifacts_dir + os.path.sep).replace('\\', '\\\\')
        self.assertFilesEqual(exp_file, self.obj.script, str_to_replace, "/somewhere/", python_files=True)
        with open(self.obj.script) as script:
            self.assertIn("bzt.resources.selenium_extras", script.read())
    ...
    def test_conditions(self):
        ...
        self.obj.prepare()
        exp_file = RESOURCES_DIR + "selenium/generated_from_requests_if_then_else_4_10.py"
        str_to_replace = (self.obj.engine.artifacts_dir + os.path.sep).replace('\\', '\\\\')
        self.assertFilesEqual(exp_file, self.obj.script, str_to_replace, "/somewhere/", python_files=True)
    ...
    def test_loop_w_variables(self):
        ...
        self.obj.prepare()
        exp_file = RESOURCES_DIR + "selenium/generated_from_requests_loop_variables_4_10.py"
        str_to_replace = (self.obj.engine.artifacts_dir + os.path.sep).replace('\\', '\\\\')
        self.assertFilesEqual(exp_file, self.obj.script, str_to_replace, "/somewhere/", python_files=True)
    ...
    def test_foreach_all_by_element_actions(self):
        ...
        self.obj.prepare()
        exp_file = RESOURCES_DIR + "selenium/generated_from_requests_foreach_4_10.py"
        str_to_replace = (self.obj.engine.artifacts_dir + os.path.sep).replace('\\', '\\\\')
        self.assertFilesEqual(exp_file, self.obj.script, str_to_replace, "/somewhere/", python_files=True)
    ...
    def test_all_by_shadow_actions(self):
        ...
        self.obj.prepare()
        exp_file = RESOURCES_DIR + "selenium/generated_from_requests_shadow_4_10.py"
        str_to_replace = (self.obj.engine.artifacts_dir + os.path.sep).replace('\\', '\\\\')
        self.assertFilesEqual(exp_file, self.obj.script, str_to_replace, "/somewhere/", python_files=True)
