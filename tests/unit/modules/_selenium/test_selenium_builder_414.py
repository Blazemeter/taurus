...
from tests.unit.modules._selenium import SeleniumTestCase, MockPythonTool414
...
class TestSeleniumScriptGeneration(ExecutorTestCase):
    ...
    def setUp(self):
        ...
        bzt.modules._selenium.Selenium = MockPythonTool414
        bzt.modules._apiritif.executor.Apiritif = MockPythonTool414
        bzt.modules._apiritif.executor.Selenium = MockPythonTool414
