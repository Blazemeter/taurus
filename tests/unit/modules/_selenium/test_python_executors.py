...
from tests.unit.modules._selenium import SeleniumTestCase, MockPythonTool, MockWebDriver
...
class TestPyTestExecutor(ExecutorTestCase):
    ...
    def test_blazedemo(self):
        ...
        self.obj_prepare()
        driver = self.obj._get_tool(MockWebDriver, tool_path=self.obj.settings.get('geckodriver').get('path'))
