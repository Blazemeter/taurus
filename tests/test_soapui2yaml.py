...
class TestConverter(BZTestCase):
    ...
    def test_convert(self):
        ...
        expected = full_load(open(RESOURCES_DIR + "soapui/project.xml.yml").read())
    ...
    def test_flickr(self):
        ...
        process(options, [source])
        actual = full_load(open(result).read())
        expected = full_load(open(RESOURCES_DIR + "soapui/flickr-sample.xml.yml").read())
        self.assertEqual(actual, expected)
    ...
    def test_egalaxy(self):
        ...
        process(options, [source])
        actual = full_load(open(result).read())
        expected = full_load(open(RESOURCES_DIR + "soapui/egalaxy.xml.yml").read())
        self.assertEqual(actual, expected)
    ...
    def test_smart(self):
        ...
        process(options, [source])
        actual = full_load(open(result).read())
        expected = full_load(open(RESOURCES_DIR + "soapui/smart.xml.yml").read())
        self.assertEqual(actual, expected)