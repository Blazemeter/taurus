...
class TestCloudProvisioning(BZTestCase):
    ...
    def test_toplevel_locations(self):
        ...
        conf = full_load(open(os.path.join(self.obj.engine.artifacts_dir, "cloud.yml")))
    ...
    def test_locations_on_both_levels(self):
        ...
        cloud_config = full_load(open(os.path.join(self.obj.engine.artifacts_dir, "cloud.yml")))
