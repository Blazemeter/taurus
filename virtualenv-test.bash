...
# install depends
pip install --upgrade colorlog pyyaml psutil lxml cssselect nose urwid coverage six pylint selenium==2.53.1 progressbar33 locustio pyvirtualdisplay pynsist
