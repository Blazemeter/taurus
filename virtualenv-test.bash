...
# install depends
<<<<<<< HEAD
pip install --upgrade colorlog pyyaml psutil!=4.4.0 lxml cssselect nose urwid six pylint selenium\<=3.3.0 progressbar33 locustio pyvirtualdisplay pynsist

=======
pip install --upgrade colorlog pyyaml psutil!=4.4.0 lxml cssselect nose urwid six pylint selenium progressbar33 locustio pyvirtualdisplay pynsist jsonpath-rw
>>>>>>> c117d772325d4ccff5757cb91a46511a019a6991
