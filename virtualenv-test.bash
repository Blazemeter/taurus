...
# install depends
pip install --upgrade colorlog pyyaml psutil!=4.4.0 lxml cssselect nose urwid six pylint selenium progressbar33 locustio pyvirtualdisplay pynsist apiritif
