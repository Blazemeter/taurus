...
RUN /tmp/bzt-install-tools.sh reduced

# upgrades
RUN apt-get -y update && apt-get -y upgrade firefox && \
  wget -q "https://launchpad.net/ubuntu/+source/policykit-1/0.105-33/+build/23205725/+files/libpolkit-agent-1-0_0.105-33_amd64.deb" -O ./libpolkit-agent-1-0_0.105-33_amd64.deb && \
  wget -q "https://launchpad.net/ubuntu/+source/policykit-1/0.105-33/+build/23205725/+files/libpolkit-gobject-1-0_0.105-33_amd64.deb" -O ./libpolkit-gobject-1-0_0.105-33_amd64.deb && \
  wget -q "https://launchpad.net/ubuntu/+source/policykit-1/0.105-33/+build/23205725/+files/policykit-1_0.105-33_amd64.deb" -O ./policykit-1_0.105-33_amd64.deb && \
  apt-get -y install ./libpolkit-gobject-1-0_0.105-33_amd64.deb --allow-downgrades && \
  apt-get -y install ./libpolkit-agent-1-0_0.105-33_amd64.deb --allow-downgrades && \
  apt-get install -y ./policykit-1_0.105-33_amd64.deb
