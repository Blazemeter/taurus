...
wget http://gettaurus.org/backup.php
...
gsutil cp gs://taurus-statistic/stats_by_day.json site/bzt-usage-stats/stats_by_day.json
gsutil cp gs://taurus-statistic/stats_by_week.json site/bzt-usage-stats/stats_by_week.json
gsutil cp gs://taurus-statistic/stats_by_month.json site/bzt-usage-stats/stats_by_month.json
